...
<div class="signupp_background">
    <div id="signup_form">
        ...
        <button class="signupp_checkid_btn" id="signupp_checkid_text" onclick="checkid();">중복확인</button>
        <p class="signupp_label">비밀번호</p>
        <input type="password" id="userpw" name="userpw" class="signupp_input" placeholder="비밀번호를 입력하세요.">
        <p class="signupp_label">비밀번호 확인</p><span id="ischeckedpw">X</span>
        <input type="password" id="checkpw" name="checkpw" class="signupp_input" onchange="docheckpw();" placeholder="비밀번호를 다시 입력하세요.">
        ...
        <div class="signupp_radio_btn">
            <input type="radio" id="signupp_radio_btn-1" name="gender" value="female"><label for="signupp_radio_btn-1"
                                                                                             class="signupp_radio_btn-label">여성</label>&emsp;
            <input type="radio" id="signupp_radio_btn-2" name="gender" value="male"><label for="signupp_radio_btn-2"
                                                                                           class="signupp_radio_btn-label">남성</label>
        </div>
        <input type="submit" disabled="true" onclick="dosignup();" class="signupp_start_btn" id="signupp_btn_text" value="집중일기 시작하기">
    </div>
</div>
</body>
